...
namespace ProjectLapShop.Migrations
{
    ...
    [Migration("20241216122831_Wishlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectLapShop.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbPages", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("ProjectLapShop.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectLapShop.Models.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectLapShop.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("ProjectLapShop.Models.TbBusinessInfo", "CutomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbItem", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("ProjectLapShop.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("ProjectLapShop.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbItemDiscount", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("ProjectLapShop.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("ProjectLapShop.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectLapShop.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
